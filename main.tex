...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Sobre mim}
            \begin{quote}
                Espero contribuir e aprender.
            \end{quote}
        % ----- ABOUT ME -----
        
        % ----- EXPERIENCE -----
        \cvsection{Experiência}
            \cvevent{Desenvolvedor Front-End}{MMTools Consultoria e Projetos de Informática Ltda., nome-fantasia OneBeleza}{Jun 2021 -- Set 2021}{Belo Horizonte, Brasil}
            \begin{itemize}
                \item Desenvolvedor Front-End Developer
                \item Experimentações como Desenvolvedor Back-End
            \end{itemize}
            \divider
        ...
        % ----- EDUCATION -----
        \cvsection{Educação}
            \cvevent{Ensino Médio}{Instituto Educacional Novos Tempos}{Jul 2004 -- Dez 2015}{Contagem, Brasil}
            %\begin{itemize}
            %    \item GPA: 1,23
            %\end{itemize}
            \divider
            
            \cvevent{Bacharel em Ciências Contábeis (Dois períodos)}{Pontifícia Universidade Católica de Minas Gerais}{Fev 2016 -- Dez 2016}{Belo Horizonte, Brasil}
            \divider
            
            \cvevent{Bacharel em Ciência da Computação}{Pontifícia Universidade Católica de Minas Gerais}{Fev 2017 -- Ago 2023}{Belo Horizonte, Brasil}
            \divider
            
            \cvevent{Especialização em Inteligência Artificial e Aprendizado de Máquina}{Pontifícia Universidade Católica de Minas Gerais}{Ago 2023 -- Jul 2024}{Belo Horizonte, Brasil}
        % ----- EDUCATION -----
